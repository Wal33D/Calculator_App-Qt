...
double Calculator::subtract(double x, double y) { return x - y; }
...
void Calculator::setFirstOperand(double x) { m_firstOperand = x; }

// Function to set the second operand
void Calculator::setSecondOperand(double y) { m_secondOperand = y; }

// Function to set the operator
void Calculator::setOperator(char op) { m_operator = op; }
...
void Calculator::setDigit(int digit) { m_currentInput.append(QString::number(digit)); }
...
// Function to set the modulo operator and store the first operand
